...
func (c *exampleService) PostHouses(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *exampleHandler) PostHouses(ctx context.Context, in *Request, out *Response) error {
