...
func (c *exampleService) DeleteSession(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *exampleHandler) DeleteSession(ctx context.Context, in *Request, out *Response) error {
