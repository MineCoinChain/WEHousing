...
__PS:
     ...
     3.如果对区块链技术不太感冒也不用担心，在实现上我采用了微服务和区块链分离的策略，首先通过微服务实现项目的基本功能，随后通过fabric对房产信息进行认证存储。只想学习微服务的同学可以绕过fabric这一部分。
     4.fabric环境搭建比较复杂，请克制砸电脑的冲动。
     5.我的仓库里有一个HouseTracing的项目，没事也可以看看，这是一个基于fabric的房产溯源认证平台。
__
