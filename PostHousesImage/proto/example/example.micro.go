...
func (c *exampleService) PostHousesImage(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (h *exampleHandler) PostHousesImage(ctx context.Context, in *Request, out *Response) error {
